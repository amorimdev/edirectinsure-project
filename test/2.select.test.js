...
describe('Project Select Tests', () => {
  ...
  it('Expect to select all project', done => {
    try {
  ...
  it('Expect to not select one project because project not found', done => {
    try {
      const pattern = Mock.pattern
  ...
  it('Expect to select one project', done => {
    try {
      const pattern = Mock.pattern
